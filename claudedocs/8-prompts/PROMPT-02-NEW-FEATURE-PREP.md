...
```bash
# 檢查 Domain Layer
find "C:\AI Semantic Kernel\src\AIAgentPlatform.Domain" -name "*.cs" | grep -E "(Entities|ValueObjects|Events)"

# 檢查 Application Layer
find "C:\AI Semantic Kernel\src\AIAgentPlatform.Application" -name "*.cs" | grep -E "(Commands|Queries|Handlers)"

# 檢查 Infrastructure Layer
find "C:\AI Semantic Kernel\src\AIAgentPlatform.Infrastructure" -name "*.cs" | grep -E "(Repositories|Configurations)"

# 檢查 API Controllers
find "C:\AI Semantic Kernel\src\AIAgentPlatform.API\Controllers" -name "*Controller.cs"
```
