...
```bash
# 搜索錯誤訊息相關代碼
grep -r "錯誤訊息關鍵字" "C:\AI Semantic Kernel\src" --include="*.cs"

# 搜索相關功能模組
find "C:\AI Semantic Kernel\src" -name "*[相關模組]*.cs"
...
```bash
# 搜索調用該功能的代碼
grep -r "問題函數名" "C:\AI Semantic Kernel\src" --include="*.cs"

# 檢查相關測試
find "C:\AI Semantic Kernel\tests" -name "*[相關功能]*Tests.cs"
```
